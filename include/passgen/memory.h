...
passgen_mem_t
passgen_mem_limited(passgen_mem_limits_t *limits);

passgen_mem_limits_t
passgen_mem_limits(passgen_mem_t *mem, size_t size, size_t allocs);

passgen_mem_accounting_t
passgen_mem_accounting_new(passgen_mem_t *mem);

passgen_mem_t
passgen_mem_accounting(passgen_mem_accounting_t *acc);
