...
test_result test_pattern_parse_str() {
     ...
     segment =
         passgen_array_get(&segments->items, sizeof(pattern_segment_t), 0);
     assert(segment);
     ...
     segment =
         passgen_array_get(&segments->items, sizeof(pattern_segment_t), 1);
     assert(segment);
     assert(segment->kind == PATTERN_CHAR);
     ...
     segment =
         passgen_array_get(&segments->items, sizeof(pattern_segment_t), 2);
     assert(segment);
     assert(segment->kind == PATTERN_CHAR);
...
test_result test_pattern_escapable() {
     ...
     assert(segment->data.character.codepoint == '(');
     segment =
         passgen_array_get(&segments->items, sizeof(pattern_segment_t), 3);
     assert(segment);
     assert(segment->kind == PATTERN_CHAR);
     assert(segment->data.character.pos.offset == 6);
     assert(segment->data.character.pos.length == 2);
     assert(segment->data.character.codepoint == ')');
     segment =
         passgen_array_get(&segments->items, sizeof(pattern_segment_t), 4);
     assert(segment);
     assert(segment->kind == PATTERN_CHAR);
     ...
     assert(segment->data.character.codepoint == '{');
     segment =
         passgen_array_get(&segments->items, sizeof(pattern_segment_t), 5);
     assert(segment);
     assert(segment->kind == PATTERN_CHAR);
     ...
     assert(segment->data.character.codepoint == '}');
     segment =
         passgen_array_get(&segments->items, sizeof(pattern_segment_t), 6);
     assert(segment);
     assert(segment->kind == PATTERN_CHAR);
